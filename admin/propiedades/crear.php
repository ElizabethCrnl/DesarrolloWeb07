...
//Ejecutar el código después de que usuario  envia el formulario
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($imagen['size'] > $medida ) {
        $errores[] = 'La imagen es mayor a 100kb';
    }
    ...
    if (empty($errores)) {
        ...
        if($resultado) {
           //Rediccionar al usuario
            header('Location: /bienesraices/bienesraicesPHP/admin/index.php?resultado=1');
        }
    }
}
...
?>
    ...
    <main class="contenedor seccion">
        ...
        <a href="/bienesraices/bienesraicesPHP/admin/index.php" class="boton boton-verde">Volver</a>
        ...
        <form  class="formulario" method="POST" action="/bienesraices/bienesraicesPHP/admin/propiedades/crear.php" enctype="multipart/form-data">
            <fieldset>
